...
class DataLoader3:
    ...
    def __init__(self):
        print("Initializing Panoptic Dataset Loader...")
    ...
    def extract(self):
        root = os.path.join(os.getcwd(), 'result_dataset_panoptic')
                    ...
                    if not os.path.exists(curr_folder):
                        ...
                        for file_name in os.listdir(curr_dir2):
                            ...
                            if not 'keypoints' in file_name and not 'flat' in file_name:
                                self.index2dir[self.numofphotos] = os.path.join(curr_folder,
                                                                                file_name)  # the symlinked path.
                                code = file_name[:2]
